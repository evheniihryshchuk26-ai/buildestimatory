...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: `${s.title} | BuildEstimatory`,
    description: s.metaDescription,
    url: `${siteConfig.url}/guides/composite-vs-wood-decking/`,
  ...
  alternates: {
    canonical: `${siteConfig.url}/guides/composite-vs-wood-decking/`,
    languages: {
      en: "https://buildestimatory.com/guides/composite-vs-wood-decking/",
      es: "https://es.buildestimatory.com/guides/composite-vs-wood-decking/",
      "x-default": "https://buildestimatory.com/guides/composite-vs-wood-decking/",
    },
  },
};

export default function CompositeVsWoodDeckingPage() {
  const breadcrumbJsonLd = breadcrumbSchema([
    { name: t.breadcrumb.home, url: "/" },
    { name: g.breadcrumbGuides, url: "/guides/" },
    { name: s.title, url: "/guides/composite-vs-wood-decking/" },
  ]);
  ...
  const articleJsonLd = {
    ...
    mainEntityOfPage: {
      "@type": "WebPage",
      "@id": `${siteConfig.url}/guides/composite-vs-wood-decking/`,
    },
    ...
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
      ...
      <section className="mb-10">
        <h2 className="text-2xl font-bold text-gray-900 mb-4">
          {s.whatIsCompositeHeading}
        </h2>
        <div className="prose prose-gray max-w-none space-y-4">
          <p className="text-gray-600 leading-relaxed">{s.whatIsCompositeText1}</p>
          <p className="text-gray-600 leading-relaxed">{s.whatIsCompositeText2}</p>
        </div>
      </section>
      ...
      <section className="mb-10">
        ...
        <div className="prose prose-gray max-w-none space-y-4">
          <p className="text-gray-600 leading-relaxed">{s.whatIsWoodText1}</p>
          <p className="text-gray-600 leading-relaxed">{s.whatIsWoodText2}</p>
        </div>
      </section>
      ...
      <section className="mb-10">
        <h2 className="text-2xl font-bold text-gray-900 mb-4">
          {s.whenCompositeHeading}
        </h2>
        <p className="text-gray-600 mb-4">{s.whenCompositeIntro}</p>
        <ul className="space-y-3 mb-4">
          {s.whenCompositeItems.map((item, i) => (
      ...
      <section className="mb-10">
        ...
        <p className="text-gray-600 mb-4">{s.whenWoodIntro}</p>
        <ul className="space-y-3 mb-4">
          {s.whenWoodItems.map((item, i) => (
            <li key={i} className="flex gap-3">
              <span className="text-orange-500 font-bold mt-0.5 shrink-0" aria-hidden="true">
                &bull;
              </span>
