...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: `${s.title} | BuildEstimatory`,
    description: s.metaDescription,
    url: `${siteConfig.url}/guides/flooring-cost-guide/`,
  ...
  alternates: {
    canonical: `${siteConfig.url}/guides/flooring-cost-guide/`,
    languages: {
      en: "https://buildestimatory.com/guides/flooring-cost-guide/",
      es: "https://es.buildestimatory.com/guides/flooring-cost-guide/",
      de: "https://de.buildestimatory.com/guides/flooring-cost-guide/",
      fr: "https://fr.buildestimatory.com/guides/flooring-cost-guide/",
      pt: "https://pt.buildestimatory.com/guides/flooring-cost-guide/",
      "en-GB": "https://uk.buildestimatory.com/guides/flooring-cost-guide/",
      "en-CA": "https://ca.buildestimatory.com/guides/flooring-cost-guide/",
      it: "https://it.buildestimatory.com/guides/flooring-cost-guide/",
      pl: "https://pl.buildestimatory.com/guides/flooring-cost-guide/",
      "x-default": "https://buildestimatory.com/guides/flooring-cost-guide/",
    },
  },
};
...
export default function FlooringCostGuidePage() {
  const breadcrumbJsonLd = breadcrumbSchema([
    ...
    { name: s.title, url: "/guides/flooring-cost-guide/" },
  ]);
  ...
  const articleJsonLd = {
    ...
    mainEntityOfPage: {
      "@type": "WebPage",
      "@id": `${siteConfig.url}/guides/flooring-cost-guide/`,
    },
    ...
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
      ...
      <section className="mb-10">
        <h2 className="text-2xl font-bold text-gray-900 mb-2">
          {s.flooringTypesHeading}
        </h2>
        <p className="text-gray-500 mb-6">{s.flooringTypesIntro}</p>
      ...
      <section className="mb-10">
        ...
        <p className="text-gray-500 mb-6">{s.costByRoomIntro}</p>
          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="bg-gray-50">
                ...
                <th className="text-left px-4 py-3 font-bold text-orange-600 border-b border-gray-200">
                  {s.costByRoomColTypical}
                </th>
                <th className="text-left px-4 py-3 font-bold text-gray-700 border-b border-gray-200">
                  {s.costByRoomColNotes}
                </th>
              </tr>
            </thead>
            <tbody>
              {s.costByRoomRows.map((row, i) => (
                <tr
                  key={i}
                  className={i % 2 === 0 ? "bg-white" : "bg-gray-50"}
                >
      ...
      <section className="mb-10">
        <h2 className="text-2xl font-bold text-gray-900 mb-4">
          {s.installationCostsHeading}
        </h2>
        <p className="text-gray-600 mb-4">{s.installationCostsIntro}</p>
        <div className="space-y-4">
          <p className="text-gray-600 leading-relaxed">{s.installationCostsText1}</p>
          <p className="text-gray-600 leading-relaxed">{s.installationCostsText2}</p>
          <p className="text-gray-600 leading-relaxed">{s.installationCostsText3}</p>
        </div>
      </section>
