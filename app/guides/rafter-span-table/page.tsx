...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: `${s.title} | BuildEstimatory`,
    description: s.metaDescription,
    url: `${siteConfig.url}/guides/rafter-span-table/`,
  ...
  alternates: {
    canonical: `${siteConfig.url}/guides/rafter-span-table/`,
    languages: {
      en: "https://buildestimatory.com/guides/rafter-span-table/",
      es: "https://es.buildestimatory.com/guides/rafter-span-table/",
      de: "https://de.buildestimatory.com/guides/rafter-span-table/",
      fr: "https://fr.buildestimatory.com/guides/rafter-span-table/",
      pt: "https://pt.buildestimatory.com/guides/rafter-span-table/",
      "en-GB": "https://uk.buildestimatory.com/guides/rafter-span-table/",
      "en-CA": "https://ca.buildestimatory.com/guides/rafter-span-table/",
      it: "https://it.buildestimatory.com/guides/rafter-span-table/",
      pl: "https://pl.buildestimatory.com/guides/rafter-span-table/",
      "x-default": "https://buildestimatory.com/guides/rafter-span-table/",
    },
  },
};

export default function RafterSpanTablePage() {
  const breadcrumbJsonLd = breadcrumbSchema([
    { name: t.breadcrumb.home, url: "/" },
    { name: g.breadcrumbGuides, url: "/guides/" },
    { name: s.title, url: "/guides/rafter-span-table/" },
  ]);
  ...
  const articleJsonLd = {
    ...
    mainEntityOfPage: {
      "@type": "WebPage",
      "@id": `${siteConfig.url}/guides/rafter-span-table/`,
    },
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
      ...
      <section className="mb-10">
        ...
        <p className="text-gray-600 mb-4">{s.snowLoadIntro}</p>
        <ul className="space-y-3 mb-4">
          {s.snowLoadItems.map((item, i) => (
      ...
      <section className="mb-10">
        <h2 className="text-2xl font-bold text-gray-900 mb-4">
          {s.pitchFactorsHeading}
        </h2>
        <p className="text-gray-600 mb-4">{s.pitchFactorsIntro}</p>
        <ul className="space-y-3 mb-4">
          {s.pitchFactorsItems.map((item, i) => (
            <li key={i} className="flex gap-3">
              <span className="text-orange-500 font-bold mt-0.5 shrink-0" aria-hidden="true">
                &bull;
              </span>
