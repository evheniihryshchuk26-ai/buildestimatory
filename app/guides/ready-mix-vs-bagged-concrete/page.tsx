...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: `${s.title} | BuildEstimatory`,
    description: s.metaDescription,
    url: `${siteConfig.url}/guides/ready-mix-vs-bagged-concrete/`,
  ...
  alternates: {
    canonical: `${siteConfig.url}/guides/ready-mix-vs-bagged-concrete/`,
    languages: {
      en: "https://buildestimatory.com/guides/ready-mix-vs-bagged-concrete/",
      es: "https://es.buildestimatory.com/guides/ready-mix-vs-bagged-concrete/",
      "x-default": "https://buildestimatory.com/guides/ready-mix-vs-bagged-concrete/",
    },
  },
};
...
export default function ReadyMixVsBaggedPage() {
  const breadcrumbJsonLd = breadcrumbSchema([
    ...
    { name: s.title, url: "/guides/ready-mix-vs-bagged-concrete/" },
  ]);
  ...
  const articleJsonLd = {
    ...
    mainEntityOfPage: {
      "@type": "WebPage",
      "@id": `${siteConfig.url}/guides/ready-mix-vs-bagged-concrete/`,
    },
    ...
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
      ...
      <section className="mb-10">
        <h2 className="text-2xl font-bold text-gray-900 mb-4">
          {s.whatIsReadyMixHeading}
        </h2>
        <div className="prose prose-gray max-w-none space-y-4">
          <p className="text-gray-600 leading-relaxed">{s.whatIsReadyMixText1}</p>
          <p className="text-gray-600 leading-relaxed">{s.whatIsReadyMixText2}</p>
        </div>
      </section>
      ...
      <section className="mb-10">
        <h2 className="text-2xl font-bold text-gray-900 mb-4">
          {s.whatIsBaggedHeading}
        </h2>
        <div className="prose prose-gray max-w-none space-y-4">
          <p className="text-gray-600 leading-relaxed">{s.whatIsBaggedText1}</p>
          <p className="text-gray-600 leading-relaxed">{s.whatIsBaggedText2}</p>
        </div>
      </section>
      ...
      <section className="mb-10">
        <h2 className="text-2xl font-bold text-gray-900 mb-4">
          {s.whenReadyMixHeading}
        </h2>
        <p className="text-gray-600 mb-4">{s.whenReadyMixIntro}</p>
        <ul className="space-y-3 mb-4">
          {s.whenReadyMixItems.map((item, i) => (
      ...
      <section className="mb-10">
        ...
        <p className="text-gray-600 mb-4">{s.whenBaggedIntro}</p>
        <ul className="space-y-3 mb-4">
          {s.whenBaggedItems.map((item, i) => (
            <li key={i} className="flex gap-3">
              <span className="text-orange-500 font-bold mt-0.5 shrink-0" aria-hidden="true">
                &bull;
              </span>
