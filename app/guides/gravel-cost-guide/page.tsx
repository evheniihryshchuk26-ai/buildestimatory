...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: `${s.title} | BuildEstimatory`,
    description: s.metaDescription,
    url: `${siteConfig.url}/guides/gravel-cost-guide/`,
  ...
  alternates: {
    canonical: `${siteConfig.url}/guides/gravel-cost-guide/`,
    languages: {
      en: "https://buildestimatory.com/guides/gravel-cost-guide/",
      es: "https://es.buildestimatory.com/guides/gravel-cost-guide/",
      de: "https://de.buildestimatory.com/guides/gravel-cost-guide/",
      fr: "https://fr.buildestimatory.com/guides/gravel-cost-guide/",
      pt: "https://pt.buildestimatory.com/guides/gravel-cost-guide/",
      "en-GB": "https://uk.buildestimatory.com/guides/gravel-cost-guide/",
      "en-CA": "https://ca.buildestimatory.com/guides/gravel-cost-guide/",
      it: "https://it.buildestimatory.com/guides/gravel-cost-guide/",
      pl: "https://pl.buildestimatory.com/guides/gravel-cost-guide/",
      "x-default": "https://buildestimatory.com/guides/gravel-cost-guide/",
    },
  },
};
...
export default function GravelCostGuidePage() {
  const breadcrumbJsonLd = breadcrumbSchema([
    ...
    { name: s.title, url: "/guides/gravel-cost-guide/" },
  ]);
  ...
  const articleJsonLd = {
    ...
    mainEntityOfPage: {
      "@type": "WebPage",
      "@id": `${siteConfig.url}/guides/gravel-cost-guide/`,
    },
    ...
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
      ...
      <section className="mb-10">
        <h2 className="text-2xl font-bold text-gray-900 mb-2">
          {s.gravelTypesHeading}
        </h2>
        <p className="text-gray-500 mb-6">{s.gravelTypesIntro}</p>
      ...
      <section className="mb-10">
        <h2 className="text-2xl font-bold text-gray-900 mb-4">
          {s.deliveryCostsHeading}
        </h2>
        <p className="text-gray-600 mb-4">{s.deliveryCostsIntro}</p>
        <div className="space-y-4">
          <p className="text-gray-600 leading-relaxed">{s.deliveryCostsText1}</p>
          <p className="text-gray-600 leading-relaxed">{s.deliveryCostsText2}</p>
          <p className="text-gray-600 leading-relaxed">{s.deliveryCostsText3}</p>
        </div>
      </section>
