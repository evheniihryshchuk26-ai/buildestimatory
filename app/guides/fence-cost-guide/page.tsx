...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: `${s.title} | BuildEstimatory`,
    description: s.metaDescription,
    url: `${siteConfig.url}/guides/fence-cost-guide/`,
  ...
  alternates: {
    canonical: `${siteConfig.url}/guides/fence-cost-guide/`,
    languages: {
      en: "https://buildestimatory.com/guides/fence-cost-guide/",
      es: "https://es.buildestimatory.com/guides/fence-cost-guide/",
      de: "https://de.buildestimatory.com/guides/fence-cost-guide/",
      fr: "https://fr.buildestimatory.com/guides/fence-cost-guide/",
      pt: "https://pt.buildestimatory.com/guides/fence-cost-guide/",
      "en-GB": "https://uk.buildestimatory.com/guides/fence-cost-guide/",
      "en-CA": "https://ca.buildestimatory.com/guides/fence-cost-guide/",
      it: "https://it.buildestimatory.com/guides/fence-cost-guide/",
      pl: "https://pl.buildestimatory.com/guides/fence-cost-guide/",
      "x-default": "https://buildestimatory.com/guides/fence-cost-guide/",
    },
  },
};
...
export default function FenceCostGuidePage() {
  const breadcrumbJsonLd = breadcrumbSchema([
    ...
    { name: s.title, url: "/guides/fence-cost-guide/" },
  ]);
  ...
  const articleJsonLd = {
    ...
    mainEntityOfPage: {
      "@type": "WebPage",
      "@id": `${siteConfig.url}/guides/fence-cost-guide/`,
    },
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
      ...
      <section className="mb-10">
        ...
        <p className="text-gray-500 mb-6">{s.fenceTypesIntro}</p>
            ...
            <thead>
              <tr className="bg-gray-50">
                ...
                <th className="text-left px-4 py-3 font-bold text-gray-700 border-b border-gray-200">
                  {s.fenceTypesColBestFor}
                </th>
              </tr>
            </thead>
            <tbody>
              {s.fenceTypesRows.map((row, i) => (
                <tr
                  key={i}
      ...
      <section className="mb-10">
        ...
        <p className="text-gray-600 mb-4">{s.laborCostsIntro}</p>
        <div className="space-y-4">
          <p className="text-gray-600 leading-relaxed">{s.laborCostsText1}</p>
          <p className="text-gray-600 leading-relaxed">{s.laborCostsText2}</p>
          <p className="text-gray-600 leading-relaxed">{s.laborCostsText3}</p>
        </div>
      </section>
      ...
      <section className="mb-10">
        ...
        <p className="text-gray-600 mb-4">{s.diyVsProIntro}</p>
        <ul className="space-y-3 mb-4">
          {s.diyVsProItems.map((item, i) => (
