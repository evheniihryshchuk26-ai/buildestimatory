...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: `${s.title} | BuildEstimatory`,
    description: s.metaDescription,
    url: `${siteConfig.url}/guides/joist-span-table/`,
  ...
  alternates: {
    canonical: `${siteConfig.url}/guides/joist-span-table/`,
    languages: {
      en: "https://buildestimatory.com/guides/joist-span-table/",
      es: "https://es.buildestimatory.com/guides/joist-span-table/",
      de: "https://de.buildestimatory.com/guides/joist-span-table/",
      fr: "https://fr.buildestimatory.com/guides/joist-span-table/",
      pt: "https://pt.buildestimatory.com/guides/joist-span-table/",
      "en-GB": "https://uk.buildestimatory.com/guides/joist-span-table/",
      "en-CA": "https://ca.buildestimatory.com/guides/joist-span-table/",
      it: "https://it.buildestimatory.com/guides/joist-span-table/",
      pl: "https://pl.buildestimatory.com/guides/joist-span-table/",
      "x-default": "https://buildestimatory.com/guides/joist-span-table/",
    },
  },
};

export default function JoistSpanTablePage() {
  const breadcrumbJsonLd = breadcrumbSchema([
    { name: t.breadcrumb.home, url: "/" },
    { name: g.breadcrumbGuides, url: "/guides/" },
    { name: s.title, url: "/guides/joist-span-table/" },
  ]);
  ...
  const articleJsonLd = {
    ...
    mainEntityOfPage: {
      "@type": "WebPage",
      "@id": `${siteConfig.url}/guides/joist-span-table/`,
    },
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
      ...
      <section className="mb-10">
        <h2 className="text-2xl font-bold text-gray-900 mb-4">
          {s.loadRequirementsHeading}
        </h2>
        <p className="text-gray-600 mb-4">{s.loadRequirementsIntro}</p>
        <ul className="space-y-3 mb-4">
          {s.loadRequirementsItems.map((item, i) => (
