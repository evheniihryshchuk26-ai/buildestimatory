...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: `${s.title} | BuildEstimatory`,
    description: s.metaDescription,
    url: `${siteConfig.url}/guides/minimum-roof-pitch-for-shingles/`,
  ...
  alternates: {
    canonical: `${siteConfig.url}/guides/minimum-roof-pitch-for-shingles/`,
    languages: {
      en: "https://buildestimatory.com/guides/minimum-roof-pitch-for-shingles/",
      es: "https://es.buildestimatory.com/guides/minimum-roof-pitch-for-shingles/",
      "x-default": "https://buildestimatory.com/guides/minimum-roof-pitch-for-shingles/",
    },
  },
};

export default function MinimumRoofPitchGuidePage() {
  const breadcrumbJsonLd = breadcrumbSchema([
    { name: t.breadcrumb.home, url: "/" },
    { name: g.breadcrumbGuides, url: "/guides/" },
    { name: s.title, url: "/guides/minimum-roof-pitch-for-shingles/" },
  ]);
  ...
  const articleJsonLd = {
    ...
    mainEntityOfPage: {
      "@type": "WebPage",
      "@id": `${siteConfig.url}/guides/minimum-roof-pitch-for-shingles/`,
    },
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
      ...
      {/* Minimum Pitch by Material Table */}
      <section className="mb-10">
        <h2 className="text-2xl font-bold text-gray-900 mb-2">
          {s.materialTableHeading}
        </h2>
        <p className="text-gray-500 mb-6">{s.materialTableSubheading}</p>
      ...
      <section className="mb-10">
        ...
        <p className="text-gray-600 mb-4">{s.whyMinIntro}</p>
        <ul className="space-y-3 mb-4">
          {s.whyMinItems.map((item, i) => (
      ...
      <section className="mb-10">
        ...
        <p className="text-gray-600 mb-4">{s.belowMinIntro}</p>
        <ul className="space-y-3 mb-4">
          {s.belowMinItems.map((item, i) => (
            <li key={i} className="flex gap-3">
              <span className="text-orange-500 font-bold mt-0.5 shrink-0" aria-hidden="true">
                &bull;
              </span>
      ...
      <section className="mb-10">
        ...
        <p className="text-gray-600 mb-4">{s.solutionsIntro}</p>
        <ul className="space-y-3 mb-4">
          {s.solutionsItems.map((item, i) => (
            <li key={i} className="flex gap-3">
              <span className="text-orange-500 font-bold mt-0.5 shrink-0" aria-hidden="true">
                &bull;
              </span>
