...
const guides: GuidesTranslations = {
  ...
  index: {
    ...
    guides: [
      ...
      {
        title: "Complete Stair Building Guide: NBC Code, Calculations & Materials",
        description:
  ...
  stairBuildingGuide: {
    title: "Complete Stair Building Guide: NBC Code, Calculations & Materials (2026)",
    metaDescription: "How to build stairs — complete guide covering stair anatomy, NBC building code (9.8.2), rise & run calculations, stair types, materials, and costs for Canadian construction.",
    heroTitle: "Complete Stair Building Guide",
    heroSubtitle: "NBC Code, Calculations & Materials",
    heroDescription: "Everything about building stairs in Canada — from measuring rise and run to meeting NBC code. Covers anatomy, calculations, stair types, materials, and costs.",
    quickAnswerHeading: "Quick Answer",
    quickAnswerText: "For NBC-compliant stairs: max 200 mm (7-7/8\") rise, min 235 mm (9-1/4\") run, min 860 mm (34\") width, min 1,950 mm (6\'5\") headroom. Divide total rise by 190 mm for steps. Use 2\u00d712 SPF for stringers.",
    anatomyHeading: "Stair Anatomy", anatomyIntro: "Key components and terminology for stair construction.",
    anatomyItems: ["Rise (Riser Height): Vertical distance between treads. NBC max 200 mm (7-7/8\"). All within 6 mm.", "Run (Tread Depth): Horizontal distance nosing to nosing. NBC min 235 mm (9-1/4\").", "Stringer: Diagonal structural member. 2\u00d712 SPF lumber for notched stringers.", "Tread: Horizontal stepping surface. 5/4\u00d712 or 40 mm hardwood. 20\u201330 mm nosing.", "Riser: Vertical board. 1\u00d78 (20 mm).", "Nosing: Front edge overhang. 20\u201330 mm.", "Handrail: Required on one side for 3+ risers. Height 865\u20131,070 mm (34\u201342\").", "Baluster: Vertical members. Max 100 mm (4\") gap."],
    anatomySummary: "Understanding these components is essential for NBC compliance.",
    buildingCodeHeading: "NBC Building Code (Section 9.8.2)",
    buildingCodeIntro: "The National Building Code of Canada Section 9.8.2 sets minimum standards. Provincial codes may be stricter.",
    buildingCodeItems: ["Rise: Max 200 mm (7-7/8\"). All within 6 mm.", "Run: Min 235 mm (9-1/4\").", "Width: Min 860 mm (34\").", "Headroom: Min 1,950 mm (6\'5\").", "Handrail: Required on one side for 3+ risers. 865\u20131,070 mm high.", "Landings: Top and bottom. Min 860 mm deep.", "Guards: Required when drop > 600 mm. Min 900 mm high (1,070 mm for common stairs).", "Lighting: At top, bottom, and landings. 3-way switches for 6+ risers."],
    buildingCodeSummary: "NBC minimums \u2014 check your provincial code. Always obtain a building permit.",
    howToCalculateHeading: "How to Calculate Stairs",
    howToCalculateIntro: "Calculate step count, rise, run, and stringer length.",
    howToCalculateItems: ["Step 1 \u2014 Measure total rise between finished floors.", "Step 2 \u2014 Divide by 190 mm (7-1/2\") = risers. E.g., 2,700 / 190 \u2248 14.", "Step 3 \u2014 Actual rise = 2,700 / 14 = 192.9 mm. Check \u2264 200 mm.", "Step 4 \u2014 Run: min 235 mm. Rise + run = 430\u2013460 mm.", "Step 5 \u2014 Treads = risers - 1 = 13.", "Step 6 \u2014 Total run = 13 \u00d7 250 = 3,250 mm.", "Step 7 \u2014 Stringer = \u221a(2,700\u00b2 + 3,250\u00b2) = 4,223 mm.", "Step 8 \u2014 Check 1,950 mm headroom everywhere."],
    howToCalculateSummary: "Use our free Stair Calculator for instant NBC-compliant results.",
    stairTypesHeading: "Common Stair Types", stairTypesIntro: "Type depends on space, budget, code, and aesthetics.",
    stairTypesItems: ["Straight: Simplest. One flight. 3\u20134.5 m run. Most economical.", "L-Shaped: 90\u00b0 turn at landing. Common in Canadian two-storey homes.", "U-Shaped: 180\u00b0 turn. Less length, more width.", "Spiral: Compact. From 1,100 mm (44\"). Secondary access in lofts or basements."],
    stairTypesSummary: "Straight when space allows. L or U for limited space. Spiral for secondary access.",
    materialsHeading: "Materials & Costs",
    materialsIntro: "Material affects cost, durability, appearance, and maintenance.",
    materialsColMaterial: "Material", materialsColCost: "Cost per Step", materialsColBestFor: "Best For",
    materialsRows: [
      { material: "Pressure-Treated SPF", cost: "CAD $10 \u2013 $20", bestFor: "Exterior stairs, decks, budget" },
      { material: "SPF (Kiln-Dried)", cost: "CAD $12 \u2013 $25", bestFor: "Interior framing, carpeted stairs" },
      { material: "Red Oak Hardwood", cost: "CAD $30 \u2013 $60", bestFor: "Interior finished stairs, stained" },
      { material: "Composite", cost: "CAD $40 \u2013 $80", bestFor: "Exterior, low-maintenance decks" },
      { material: "Concrete (Precast)", cost: "CAD $50 \u2013 $120", bestFor: "Exterior entries, basements" },
    ],
    costBreakdownHeading: "Cost Breakdown", costBreakdownIntro: "Costs vary by design, materials, and DIY vs contractor.",
    costBreakdownText1: "Exterior basic: CAD $400\u2013$1,200. Interior straight: CAD $2,000\u2013$6,000. Oak treads: +30\u201350%. Pro installation: +CAD $1,500\u2013$4,000.",
    costBreakdownText2: "L/U: +20\u201340%. Spiral: CAD $2,000\u2013$7,000 (kit) to $30,000+ (custom).",
    costBreakdownText3: "DIY saves 40\u201360%. Straight staircase in 1\u20132 weekends.",
    calculatorCtaHeading: "Calculate Your Project", calculatorCtaText: "Use our free stair calculators for instant NBC-compliant dimensions.",
    calculatorLinks: [
      { label: "Stair Calculator", href: "/calculators/stairs/stair-calculator/", description: "Steps, rise, run & stringer" },
      { label: "Stringer Calculator", href: "/calculators/stairs/stair-stringer-calculator/", description: "Length, count & layout" },
      { label: "Rise Over Run", href: "/calculators/stairs/rise-over-run-calculator/", description: "Slope ratio & angle" },
      { label: "Spiral Staircase", href: "/calculators/stairs/spiral-staircase-calculator/", description: "Treads & rotation" },
      { label: "Landing Calculator", href: "/calculators/stairs/stair-landing-calculator/", description: "Split flights with landing" },
    ],
    faqHeading: "Frequently Asked Questions",
    faqs: [
      { question: "How do I build deck stairs in Canada?", answer: "Measure deck height. Divide by 190 mm. Cut stringers from treated 2\u00d712 SPF. Fix with Simpson connectors. Install treads. Gravel pad for drainage. Anti-slip treads for winter." },
      { question: "What does NBC require?", answer: "NBC 9.8.2: rise max 200 mm, run min 235 mm, width 860 mm, headroom 1,950 mm, handrail 865\u20131,070 mm, landings at top/bottom 860 mm deep. Max 6 mm variation." },
      { question: "Steps for 9-foot ceilings?", answer: "9 ft (2,743 mm) + 305 mm floor framing = 3,048 mm. 3,048 / 190 = 16 risers and 15 treads. Total run: 15 \u00d7 250 = 3,750 mm." },
