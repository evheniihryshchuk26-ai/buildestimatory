...
const common: CommonTranslations = {
  ...
  footer: {
    tagline:
      "Free construction material calculators for Canadian builders, contractors, and DIY home builders.",
    calculatorsHeading: "Calculators",
    moreToolsHeading: "More Tools",
    siteHeading: "Site",
    copyright:
      "\u00A9 {year} BuildEstimatory.com \u2014 Free construction calculators for Canadian builders.",
    disclaimer:
  ...
  layout: {
    ...
    defaultDescription:
      "Free construction material calculators for Canadian builders and contractors. Get accurate material estimates for framing, roofing, foundation, and more.",
