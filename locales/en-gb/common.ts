...
const common: CommonTranslations = {
  ...
  footer: {
    tagline:
      "Free construction material calculators for UK builders, contractors, and DIY enthusiasts.",
    calculatorsHeading: "Calculators",
    moreToolsHeading: "More Tools",
    siteHeading: "Site",
    copyright:
      "\u00A9 {year} BuildEstimatory.com \u2014 Free construction calculators for UK builders.",
    disclaimer:
      "Results are estimates. Always verify with a qualified contractor.",
  },
  ...
  layout: {
    ...
    defaultDescription:
      "Free construction material calculators for UK builders and contractors. Get accurate material estimates for timber framing, roofing, foundations, and more.",
  ...
  heroAnimation: {
    ...
    anchorBoltResult: "13 anchor bolts (3 m spacing)",
    ...
    categoryInsulationDrywall: "Insulation & Plasterboard",
