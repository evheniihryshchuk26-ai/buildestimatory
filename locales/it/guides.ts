...
const guides: GuidesTranslations = {
  ...
  index: {
    ...
    guides: [
      ...
      {
        title: "Guida Completa alla Costruzione di Scale: Norme, Calcoli e Materiali",
        description:
          "Come costruire scale — guida completa su anatomia, NTC 2018, calcoli alzata e pedata, tipi (dritta, L, U, chiocciola), materiali e costi.",
        href: "/guides/stair-building-guide",
      },
      {
        title: "Tabella Luci Travetti Solaio: Riferimento Completo NTC",
        description:
          "Tabelle luci travetti solaio per sezioni 8x16, 8x20, 8x24 cm a 40 e 60 cm. Copertura abete, larice, castagno e rovere con riferimenti NTC 2018 ed Eurocodice 5.",
        href: "/guides/joist-span-table",
      },
      {
        title: "Tabella Luci Travetti Tetto: Riferimento Completo",
        description:
          "Tabelle luci travetti tetto per sezione, interasse, pendenza e carico neve. Copertura tutte le essenze con NTC 2018 ed Eurocodice 5.",
        href: "/guides/rafter-span-table",
      },
      {
        title: "Tabella Luci Travetti Controsoffitto: Guida di Riferimento",
        description:
          "Tabelle luci travetti controsoffitto per sezione, interasse e tipo di carico. Controsoffitto leggero, sottotetto con deposito e sottotetto abitabile con NTC 2018.",
  ...
  stairBuildingGuide: {
    title: "Guida Completa alla Costruzione di Scale: NTC, Calcoli e Materiali (2026)",
    metaDescription: "Come costruire scale \u2014 guida completa su anatomia, NTC 2018, calcoli alzata/pedata, tipi (dritta, L, U, chiocciola), materiali e costi. Calcolatori gratuiti inclusi.",
    heroTitle: "Guida Completa alla Costruzione di Scale",
    heroSubtitle: "NTC, Calcoli e Materiali",
    heroDescription: "Tutto sulla costruzione di scale \u2014 dal calcolo alzata/pedata al rispetto del NTC 2018. Anatomia, metodi di calcolo, tipi comuni, materiali e costi.",
    quickAnswerHeading: "Risposta Rapida",
    quickAnswerText: "Per scale conformi NTC: alzata max. 180 mm, pedata min. 250 mm, larghezza min. 800 mm, altezza libera 2.100 mm. Formula: 2a + p = 620\u2013640 mm. Cosciali da 50\u00d7300 mm.",
    anatomyHeading: "Anatomia della Scala", anatomyIntro: "Componenti chiave e terminologia.",
    anatomyItems: ["Alzata: Distanza verticale tra pedate. Max. 180 mm. Tutte entro 5 mm.", "Pedata: Distanza orizzontale da naso a naso. Min. 250 mm.", "Cosciale: Elemento diagonale portante. 50\u00d7300 mm per dentati.", "Gradino: Superficie orizzontale. Legno massello 36\u201340 mm. Naso 20\u201330 mm.", "Alzata (contrapedata): Tavola verticale. 20\u201325 mm.", "Naso: Aggetto del gradino. 20\u201330 mm.", "Corrimano: Obbligatorio per 3+ gradini. 900\u20131.000 mm.", "Balaustre: Elementi verticali. Max 100 mm di luce."],
    anatomySummary: "Comprendere questi componenti \u00e8 essenziale per la conformit\u00e0 normativa.",
    buildingCodeHeading: "Norme NTC per Scale", buildingCodeIntro: "Il NTC 2018 e il DM 14/01/2008 stabiliscono gli standard per le scale residenziali in Italia.",
    buildingCodeItems: ["Alzata: Max. 180 mm. Variazione max. 5 mm.", "Pedata: Min. 250 mm.", "Larghezza: Min. 800 mm (1.200 mm uso pubblico).", "Altezza libera: Min. 2.100 mm.", "Corrimano: Obbligatorio per 3+ gradini. 900\u20131.000 mm.", "Pianerottoli: In alto e in basso. Min. 800 mm profondit\u00e0.", "Parapetti: Quando caduta > 1 m. Min. 1.000 mm.", "Illuminazione: In alto, in basso e ai pianerottoli."],
    buildingCodeSummary: "Requisiti minimi \u2014 verificare con il comune locale.",
    howToCalculateHeading: "Come Calcolare le Scale", howToCalculateIntro: "Il calcolo comprende numero gradini, alzata, pedata e lunghezza cosciale.",
    howToCalculateItems: ["Passo 1 \u2014 Misurare altezza totale tra pavimenti.", "Passo 2 \u2014 Dividere per 175\u2013180 mm = alzate.", "Passo 3 \u2014 Alzata reale = altezza / alzate. Verificare \u2264 180 mm.", "Passo 4 \u2014 Pedata min. 250 mm. 2a + p = 620\u2013640 mm.", "Passo 5 \u2014 Pedate = alzate - 1.", "Passo 6 \u2014 Percorso = pedate \u00d7 profondit\u00e0.", "Passo 7 \u2014 Cosciale = \u221a(altezza\u00b2 + percorso\u00b2).", "Passo 8 \u2014 Verificare 2.100 mm di altezza libera."],
    howToCalculateSummary: "Usa il nostro Calcolatore Scale gratuito per risultati istantanei.",
    stairTypesHeading: "Tipi Comuni", stairTypesIntro: "Il tipo dipende da spazio, budget, normativa ed estetica.",
    stairTypesItems: ["Scala Dritta: Pi\u00f9 semplice. Una rampa. 3\u20134,5 m. Pi\u00f9 economica.", "Scala a L: Rampa con virata 90\u00b0 al pianerottolo.", "Scala a U: Due rampe parallele con pianerottolo 180\u00b0.", "Scala a Chiocciola: Compatta. Da 1.200 mm. Per accesso secondario."],
    stairTypesSummary: "Dritta se c'\u00e8 spazio. L o U per spazi limitati. Chiocciola per accesso secondario.",
    materialsHeading: "Materiali e Costi", materialsIntro: "Il materiale influenza costo, durabilit\u00e0, estetica e manutenzione.",
    materialsColMaterial: "Materiale", materialsColCost: "Costo per Gradino", materialsColBestFor: "Ideale Per",
    materialsRows: [
      { material: "Pino Trattato", cost: "\u20ac10 \u2013 \u20ac20", bestFor: "Scale esterne, terrazze, budget" },
      { material: "Abete/Pino", cost: "\u20ac15 \u2013 \u20ac30", bestFor: "Struttura interna, scale moquettate" },
      { material: "Rovere Massello", cost: "\u20ac40 \u2013 \u20ac80", bestFor: "Scale interne finite, oliate o verniciate" },
      { material: "WPC/Composito", cost: "\u20ac50 \u2013 \u20ac100", bestFor: "Scale esterne, bassa manutenzione" },
      { material: "Calcestruzzo", cost: "\u20ac60 \u2013 \u20ac150", bestFor: "Ingressi, seminterrati, commerciale" },
    ],
    costBreakdownHeading: "Dettaglio Costi", costBreakdownIntro: "I costi variano per complessit\u00e0, materiali e modalit\u00e0.",
    costBreakdownText1: "Esterna base: \u20ac200\u2013600. Interna dritta: \u20ac2.000\u20138.000. Pedate rovere: +30\u201350%. Posa professionale: +\u20ac1.500\u20135.000.",
    costBreakdownText2: "L/U: +20\u201340%. Chiocciola: \u20ac1.500\u20136.000 (kit) a \u20ac25.000+ (su misura).",
    costBreakdownText3: "Fai-da-te: risparmio 40\u201360%. Scala dritta in 1\u20132 weekend.",
    calculatorCtaHeading: "Calcola il Tuo Progetto", calculatorCtaText: "Usa i nostri calcolatori gratuiti per dimensioni normative istantanee.",
    calculatorLinks: [
      { label: "Calcolatore Scale", href: "/calculators/stairs/stair-calculator/", description: "Gradini, alzata, pedata e cosciale" },
      { label: "Calcolatore Cosciali", href: "/calculators/stairs/stair-stringer-calculator/", description: "Lunghezza e numero" },
      { label: "Alzata/Pedata", href: "/calculators/stairs/rise-over-run-calculator/", description: "Rapporto, percentuale e angolo" },
      { label: "Chiocciola", href: "/calculators/stairs/spiral-staircase-calculator/", description: "Gradini e rotazione" },
      { label: "Pianerottolo", href: "/calculators/stairs/stair-landing-calculator/", description: "Rampe con pianerottolo" },
    ],
    faqHeading: "Domande Frequenti",
    faqs: [
      { question: "Come costruire scale per terrazza?", answer: "Misurare altezza. Dividere per 180 mm. Tagliare cosciali 50\u00d7300 mm trattati. Fissare con connettori. Installare pedate. Base ghiaia per drenaggio." },
      { question: "Cosa dice il NTC?", answer: "Alzata max. 180 mm, pedata min. 250 mm, larghezza min. 800 mm, altezza libera 2.100 mm, corrimano 900\u20131.000 mm. Max 5 mm variazione." },
      { question: "Gradini per 2,70 m?", answer: "2.700 + 300 mm = 3.000 mm. 3.000 / 180 = 17 alzate e 16 pedate. Percorso: 16 \u00d7 270 = 4.320 mm." },
      { question: "Soluzione pi\u00f9 economica?", answer: "Scala dritta in pino trattato. Cosciali 50\u00d7300 (\u20ac25\u201360/pezzo), pedate (\u20ac8\u201315/pezzo). 14 gradini: \u20ac200\u2013500." },
      { question: "Serve un permesso?", answer: "S\u00ec per scale permanenti. Permesso di costruire o CILA. Costo \u20ac100\u2013500." },
      { question: "Come usare il calcolatore?", answer: "Inserire altezza totale e pedata. Il calcolatore dà gradini, alzata, percorso e cosciale conformi al NTC." },
    ],
  },

  joistSpanTable: {
    title: "Tabella Luci Travetti Solaio: Riferimento Completo NTC",
    metaDescription: "Tabelle luci travetti solaio 8x16, 8x20, 8x24 cm a 30, 40 e 60 cm. Abete, larice, castagno e rovere con NTC 2018 ed Eurocodice 5.",
    heroTitle: "Tabella Luci Travetti Solaio",
    heroSubtitle: "Riferimento Completo NTC",
    heroDescription: "Tabelle luci massime per travetti solaio residenziali secondo NTC 2018 ed Eurocodice 5.",
    quickAnswerHeading: "Risposta Rapida",
    quickAnswerText: "Un travetto di abete C24 8x20 cm a 40 cm copre fino a 4,00 m per 200 kg/m². Uno 8x24 cm a 40 cm arriva a 5,00 m. Verificare con NTC 2018.",
    understandingHeading: "Capire le Luci dei Travetti",
    understandingText1: "La luce e' la distanza orizzontale tra appoggi senza freccia eccessiva. NTC 2018 ed Eurocodice 5 stabiliscono i criteri.",
    understandingText2: "Carichi: uso 200 kg/m² (ambienti generici) e permanente 100 kg/m² (struttura standard).",
    understandingText3: "Freccia max L/250 totale e L/300 uso. Solai rigidi prevengono fessurazioni.",
    spanTablesHeading: "Tabelle per Essenza",
    spanTablesIntro: "Basate su NTC 2018 per 200 kg/m² uso + 100 kg/m² permanente. Luci massime in metri.",
    spanTablesColSize: "Sezione",
    spanTablesCol12: "30 cm",
    spanTablesCol16: "40 cm",
    spanTablesCol24: "60 cm",
    spanTablesBySpecies: [
      { species: "Abete Rosso (C24)", grade: "fm,k = 24 MPa, E = 11.000 MPa", rows: [
        { size: "8x16 cm", oc12: "3,60 m", oc16: "3,20 m", oc24: "2,60 m" },
        { size: "8x20 cm", oc12: "4,50 m", oc16: "4,00 m", oc24: "3,30 m" },
        { size: "8x24 cm", oc12: "5,60 m", oc16: "5,00 m", oc24: "4,10 m" },
        { size: "8x28 cm", oc12: "6,60 m", oc16: "5,80 m", oc24: "4,80 m" },
      ]},
      { species: "Larice (C30)", grade: "fm,k = 30 MPa, E = 12.000 MPa", rows: [
        { size: "8x16 cm", oc12: "3,90 m", oc16: "3,50 m", oc24: "2,90 m" },
        { size: "8x20 cm", oc12: "4,90 m", oc16: "4,30 m", oc24: "3,60 m" },
        { size: "8x24 cm", oc12: "6,10 m", oc16: "5,40 m", oc24: "4,50 m" },
        { size: "8x28 cm", oc12: "7,10 m", oc16: "6,30 m", oc24: "5,20 m" },
      ]},
      { species: "Castagno (C30)", grade: "fm,k = 30 MPa, E = 12.000 MPa", rows: [
        { size: "8x16 cm", oc12: "3,90 m", oc16: "3,50 m", oc24: "2,90 m" },
        { size: "8x20 cm", oc12: "4,90 m", oc16: "4,30 m", oc24: "3,60 m" },
        { size: "8x24 cm", oc12: "6,10 m", oc16: "5,40 m", oc24: "4,50 m" },
        { size: "8x28 cm", oc12: "7,10 m", oc16: "6,30 m", oc24: "5,20 m" },
      ]},
      { species: "Rovere (D40)", grade: "fm,k = 40 MPa, E = 13.000 MPa", rows: [
        { size: "8x16 cm", oc12: "4,20 m", oc16: "3,80 m", oc24: "3,10 m" },
        { size: "8x20 cm", oc12: "5,30 m", oc16: "4,70 m", oc24: "3,90 m" },
        { size: "8x24 cm", oc12: "6,60 m", oc16: "5,90 m", oc24: "4,80 m" },
        { size: "8x28 cm", oc12: "7,70 m", oc16: "6,80 m", oc24: "5,60 m" },
      ]},
    ],
    loadRequirementsHeading: "Requisiti di Carico (NTC 2018)",
    loadRequirementsIntro: "NTC 2018 specifica i carichi minimi per solai residenziali.",
    loadRequirementsItems: ["Ambienti generici: 200+100=300 kg/m²", "Camere: 150+100=250 kg/m²", "Balconi: 400+100 kg/m²", "Autorimesse: 250 kg/m²", "Piastrelle su massetto: aumentare permanente", "Carico concentrato: 200 kg su 5x5 cm"],
    loadRequirementsSummary: "Usare tabella 200/100 per la maggior parte dei solai.",
    factorsHeading: "Fattori che Influenzano la Luce",
    factorsIntro: "Fattori reali che modificano la sezione necessaria.",
    factorsItems: ["Essenza e classe: D40 > C30 > C24", "Interasse: 30>40>60 cm", "Appoggio min: 5 cm legno, 8 cm muratura", "Intagli: terzo esterno, max 1/4 altezza", "Solai pesanti aggiungono carico", "Sbalzi: max 1/4 luce posteriore"],
    factorsSummary: "Nel dubbio aumentare di una sezione.",
    codeReferencesHeading: "Riferimenti Normativi",
    codeReferencesIntro: "Norme per travetti solaio.",
    codeReferencesItems: ["NTC 2018 Cap. 4", "Eurocodice 5 (UNI EN 1995)", "NTC 2018 Appoggi", "NTC 2018 Intagli", "UNI EN 338 Classi resistenza"],
    codeReferencesSummary: "NTC 2018 ed Eurocodice 5 sono i riferimenti vigenti.",
    calculatorCtaHeading: "Calcola i Materiali",
    calculatorCtaText: "Usa i calcolatori per travetti, connettori e fissaggi.",
    calculatorLinks: [
      { label: "Calcolatore Travetti", href: "/calculators/floor-framing/floor-joist-calculator", description: "Quantita' e blocchi." },
      { label: "Calcolatore Sottofondo", href: "/calculators/floor-framing/subfloor-calculator", description: "Pannelli OSB." },
      { label: "Calcolatore Staffe", href: "/calculators/floor-framing/joist-hanger-calculator", description: "Staffe strutturali." },
    ],
    faqHeading: "Domande Frequenti",
    faqs: [
      { question: "Luce 8x20?", answer: "Abete C24 a 40 cm: 4,00 m. Larice C30: 4,30 m. Rovere D40: 4,70 m." },
      { question: "Luce 8x24?", answer: "Abete C24 a 40 cm: 5,00 m. Castagno C30: 5,40 m." },
      { question: "Travetti 8x16?", answer: "Limitati a 2,60-3,80 m. Per stanze piccole." },
      { question: "Uso vs permanente?", answer: "Uso=persone (200). Permanente=struttura (100). Totale per tabelle." },
      { question: "40 o 60 cm?", answer: "40 standard. 60 economico ma limita luci." },
      { question: "Blocco tra travetti?", answer: "Raccomandato sopra 24 cm ogni 2,40 m." },
    ],
  },

  rafterSpanTable: {
    title: "Tabella Luci Travetti Tetto: Riferimento Completo",
    metaDescription: "Tabelle luci travetti tetto per sezione, interasse e carico neve. NTC 2018 ed Eurocodice 5.",
    heroTitle: "Tabella Luci Travetti Tetto",
    heroSubtitle: "Riferimento Completo",
    heroDescription: "Tabelle luci massime per travetti tetto residenziali secondo NTC 2018.",
    quickAnswerHeading: "Risposta Rapida",
    quickAnswerText: "Abete C24 8x16 cm a 40 cm: fino a 3,60 m con neve zona III. Per alta neve la luce diminuisce.",
    understandingHeading: "Capire le Luci Tetto",
    understandingText1: "La luce e' la proiezione orizzontale tra catena e colmo.",
    understandingText2: "Carichi: permanente 60-90 kg/m² + neve min 50 kg/m² (zona III NTC).",
    understandingText3: "Freccia max L/200. Pendenze maggiori = luci maggiori.",
    spanTablesHeading: "Tabelle per Essenza",
    spanTablesIntro: "NTC 2018 per neve 100 kg/m² (zona III) + permanente 70 kg/m². Proiezione orizzontale.",
    spanTablesColSize: "Sezione",
    spanTablesCol12: "30 cm",
    spanTablesCol16: "40 cm",
    spanTablesCol24: "60 cm",
    spanTablesBySpecies: [
      { species: "Abete Rosso (C24)", grade: "fm,k = 24 MPa", rows: [
        { size: "8x12 cm", oc12: "2,80 m", oc16: "2,50 m", oc24: "2,00 m" },
        { size: "8x16 cm", oc12: "4,00 m", oc16: "3,60 m", oc24: "2,90 m" },
        { size: "8x20 cm", oc12: "5,00 m", oc16: "4,50 m", oc24: "3,60 m" },
        { size: "8x24 cm", oc12: "6,10 m", oc16: "5,40 m", oc24: "4,40 m" },
      ]},
      { species: "Larice (C30)", grade: "fm,k = 30 MPa", rows: [
        { size: "8x12 cm", oc12: "3,10 m", oc16: "2,70 m", oc24: "2,20 m" },
        { size: "8x16 cm", oc12: "4,30 m", oc16: "3,90 m", oc24: "3,20 m" },
        { size: "8x20 cm", oc12: "5,40 m", oc16: "4,80 m", oc24: "4,00 m" },
        { size: "8x24 cm", oc12: "6,60 m", oc16: "5,90 m", oc24: "4,80 m" },
      ]},
      { species: "Abete Bianco (C22)", grade: "fm,k = 22 MPa", rows: [
        { size: "8x12 cm", oc12: "2,60 m", oc16: "2,30 m", oc24: "1,90 m" },
        { size: "8x16 cm", oc12: "3,70 m", oc16: "3,30 m", oc24: "2,70 m" },
        { size: "8x20 cm", oc12: "4,60 m", oc16: "4,10 m", oc24: "3,40 m" },
        { size: "8x24 cm", oc12: "5,60 m", oc16: "5,00 m", oc24: "4,10 m" },
      ]},
    ],
    snowLoadHeading: "Carico Neve",
    snowLoadIntro: "Il carico neve riduce le luci. NTC 2018 definisce 4 zone.",
    snowLoadItems: ["Zona III (100 kg/m²): 8x16 a 40=3,60 m", "Zona II (150): ~3,10 m", "Zona I-A (200): ~2,70 m", "Zona I-M (250): ~2,40 m", "Consultare Allegato C NTC 2018", "Pendenze >30 gradi riducono carico neve"],
    snowLoadSummary: "In montagna dimensionare sempre per il carico neve specifico.",
    pitchFactorsHeading: "Pendenza",
    pitchFactorsIntro: "Influisce su lunghezza reale, carichi e tiranti.",
    pitchFactorsItems: ["Bassa (10-20%): spinta alta, tiranti obbligatori", "Media (25-40%): spinta ridotta", "Alta (45-100%): meno flessione, piu' lunghezza", "Fattori: 20%=1,020; 30%=1,044; 50%=1,118", "Trave colmo strutturale elimina tiranti", "Tiranti alla catena vs saette"],
    pitchFactorsSummary: "Per 25-40% usare tabelle. Soffitti inclinati: trave colmo obbligatoria.",
    codeReferencesHeading: "Riferimenti",
    codeReferencesIntro: "Norme per travetti tetto.",
    codeReferencesItems: ["NTC 2018 Cap. 4", "Eurocodice 5", "NTC Allegato C neve", "NTC azioni vento", "UNI EN 338", "NTC intagli"],
    codeReferencesSummary: "NTC 2018 + Eurocodice 5 + Allegato C neve.",
    calculatorCtaHeading: "Calcola Materiali Tetto",
    calculatorCtaText: "Calcolatori per travetti, tavolato e fissaggi.",
    calculatorLinks: [
      { label: "Calcolatore Travetti", href: "/calculators/roofing/rafter-calculator", description: "Quantita' e colmo." },
      { label: "Calcolatore Tavolato", href: "/calculators/roofing/roof-sheathing-calculator", description: "Pannelli OSB." },
      { label: "Calcolatore Tegole", href: "/calculators/roofing/shingle-calculator", description: "Tegole e chiodi." },
    ],
    faqHeading: "Domande Frequenti",
    faqs: [
      { question: "Luce 8x16?", answer: "Abete C24 a 40: 3,60 m neve zona III. Larice C30: 3,90 m." },
      { question: "Luce 8x12?", answer: "2,00-2,70 m a 40 cm. Per tettoie e portici." },
      { question: "Colmo strutturale?", answer: "Tavola quando ci sono tiranti. Trave lamellare per soffitti inclinati." },
      { question: "Neve e luci?", answer: "8x16 C24 a 40: 3,60 m con 100 kg/m², ~2,40 m con 250 kg/m²." },
      { question: "Arcarecci?", answer: "Dividono la luce a meta'. Min 8x8 cm su muro portante." },
      { question: "Sezione minima?", answer: "8x14 cm (fino a 3,20 m). Per luci maggiori: 8x18 o 8x22." },
    ],
  },

  ceilingJoistSpanTable: {
    title: "Tabella Luci Travetti Controsoffitto: Guida Riferimento",
    metaDescription: "Tabelle luci travetti controsoffitto per sezione, interasse e carico. Leggero, deposito e abitabile con NTC 2018.",
    heroTitle: "Tabella Luci Travetti Controsoffitto",
    heroSubtitle: "Guida di Riferimento",
    heroDescription: "Tabelle luci per travetti controsoffitto residenziali.",
    quickAnswerHeading: "Risposta Rapida",
    quickAnswerText: "Abete C24 8x14 cm a 40 cm: fino a 4,80 m leggero. Con deposito: 3,40 m.",
    understandingHeading: "Capire le Luci",
    understandingText1: "Sostengono controsoffitto e agiscono come tiranti. Luce dipende dall'uso del sottotetto.",
    understandingText2: "Tre condizioni: non accessibile (50 kg/m²), deposito (50+100), abitabile (50+150).",
    understandingText3: "Come tiranti devono essere collegati ai travetti tetto.",
    spanTablesHeading: "Tabelle per Essenza",
    spanTablesIntro: "NTC 2018 con permanente 50 kg/m². Leggero e deposito limitato.",
    spanTablesColSize: "Sezione",
    spanTablesCol12: "30 cm",
    spanTablesCol16: "40 cm",
    spanTablesCol24: "60 cm",
    spanTablesBySpecies: [
      { species: "Abete -- Leggero", grade: "C24 -- 50 kg/m²", rows: [
        { size: "6x8 cm", oc12: "2,80 m", oc16: "2,50 m", oc24: "2,00 m" },
        { size: "8x14 cm", oc12: "5,40 m", oc16: "4,80 m", oc24: "3,90 m" },
        { size: "8x18 cm", oc12: "7,00 m", oc16: "6,20 m", oc24: "5,10 m" },
        { size: "8x22 cm", oc12: "8,50 m", oc16: "7,50 m", oc24: "6,20 m" },
      ]},
      { species: "Abete -- Deposito", grade: "C24 -- 50+100 kg/m²", rows: [
        { size: "6x8 cm", oc12: "1,90 m", oc16: "1,70 m", oc24: "1,40 m" },
        { size: "8x14 cm", oc12: "3,80 m", oc16: "3,40 m", oc24: "2,80 m" },
        { size: "8x18 cm", oc12: "5,00 m", oc16: "4,40 m", oc24: "3,60 m" },
        { size: "8x22 cm", oc12: "6,00 m", oc16: "5,30 m", oc24: "4,40 m" },
      ]},
      { species: "Larice -- Leggero", grade: "C30 -- 50 kg/m²", rows: [
        { size: "6x8 cm", oc12: "3,10 m", oc16: "2,70 m", oc24: "2,20 m" },
        { size: "8x14 cm", oc12: "5,80 m", oc16: "5,20 m", oc24: "4,20 m" },
        { size: "8x18 cm", oc12: "7,50 m", oc16: "6,70 m", oc24: "5,50 m" },
        { size: "8x22 cm", oc12: "9,20 m", oc16: "8,10 m", oc24: "6,70 m" },
      ]},
      { species: "Larice -- Deposito", grade: "C30 -- 50+100 kg/m²", rows: [
        { size: "6x8 cm", oc12: "2,10 m", oc16: "1,80 m", oc24: "1,50 m" },
        { size: "8x14 cm", oc12: "4,10 m", oc16: "3,60 m", oc24: "3,00 m" },
        { size: "8x18 cm", oc12: "5,40 m", oc16: "4,80 m", oc24: "3,90 m" },
        { size: "8x22 cm", oc12: "6,50 m", oc16: "5,80 m", oc24: "4,80 m" },
      ]},
    ],
    loadTypesHeading: "Tipi di Carico",
    loadTypesIntro: "Tre categorie NTC.",
    loadTypesItems: ["Non accessibile (50 kg/m²): solo manutenzione", "Deposito (100 kg/m²): tabella piu' usata", "Abitabile (150 kg/m²): usare tabelle solaio", "Conversione futura: dimensionare subito", "HVAC: +50-100 kg/m²"],
    loadTypesSummary: "Nel dubbio dimensionare per deposito (100 kg/m²).",
    factorsHeading: "Fattori",
    factorsIntro: "Oltre carico ed essenza.",
    factorsItems: ["Tirante: trazione aggiuntiva", "Cartongesso 12,5mm: ~10 kg/m²", "Isolamento: 5-15 kg/m²", "60 cm richiede 15 mm", "Controventatura a meta' luce"],
    factorsSummary: "Funzioni strutturali critiche come tiranti.",
    codeReferencesHeading: "Riferimenti",
    codeReferencesIntro: "Norme per controsoffitto.",
    codeReferencesItems: ["NTC 2018 travetti controsoffitto", "NTC 2018 collegamenti tiranti", "UNI 11018 controsoffitti", "NTC ventilazione"],
    codeReferencesSummary: "Dimensionamento incrocia tetto, controsoffitto e ventilazione.",
    calculatorCtaHeading: "Calcola Materiali",
    calculatorCtaText: "Calcolatori per travetti, cartongesso e fissaggi.",
    calculatorLinks: [
      { label: "Calcolatore Travetti", href: "/calculators/floor-framing/floor-joist-calculator", description: "Anche per controsoffitto." },
      { label: "Calcolatore Cartongesso", href: "/calculators/insulation-drywall/drywall-calculator", description: "Lastre e stucco." },
      { label: "Calcolatore Isolamento", href: "/calculators/insulation-drywall/insulation-calculator", description: "Materassini o insufflato." },
    ],
    faqHeading: "Domande Frequenti",
    faqs: [
      { question: "Luce 8x14?", answer: "Abete C24 a 40: 4,80 m leggero, 3,40 m deposito." },
      { question: "Travetti 6x8?", answer: "Fino a 2,50 m leggero. ~1,70 m deposito." },
      { question: "Direzione?", answer: "Paralleli ai travetti tetto come tiranti." },
      { question: "Controsoffitto vs solaio?", answer: "Stesso elemento, carico diverso: 50-150 vs 200-300 kg/m²." },
      { question: "Camminare?", answer: "Solo su deposito o abitabile. Non su leggero." },
      { question: "Rinforzare?", answer: "Affiancare nuovo travetto. Bulloni M10 ogni 40 cm." },
    ],
  },
};
