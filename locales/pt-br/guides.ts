...
const guides: GuidesTranslations = {
  ...
  index: {
    ...
    guides: [
      ...
      {
        title: "Tabela de Vãos de Vigas de Piso: Referência Completa ABNT",
        description:
          "Tabelas de vão para vigas de piso 6x16, 6x20, 6x25, 6x30 cm a 40 e 60 cm entre eixos. Cobre Peroba, Pinho, Eucalipto e Ipê com referências ABNT NBR 7190.",
        href: "/guides/joist-span-table",
      },
      {
        title: "Tabela de Vãos de Caibros: Referência Completa para Telhados",
        description:
          "Tabelas de vão de caibros por seção, espaçamento, inclinação e carga de vento/chuva. Cobre todas as espécies comuns com referências ABNT NBR 7190.",
        href: "/guides/rafter-span-table",
      },
      {
        title: "Tabela de Vãos de Vigas de Forro: Guia de Referência Completo",
        description:
          "Tabelas de vão de vigas de forro por seção, espaçamento e tipo de carga. Cobre forro leve, sótão com armazenamento e sótão habitável com referências ABNT.",
  ...
  joistSpanTable: {
    title: "Tabela de Vãos de Vigas de Piso: Referência Completa ABNT",
    metaDescription: "Tabelas de vão para vigas de piso 6x16, 6x20, 6x25, 6x30 cm a 30, 40 e 60 cm entre eixos. Cobre Peroba, Pinho, Eucalipto e Ipê com referências ABNT NBR 7190.",
    heroTitle: "Tabela de Vãos de Vigas de Piso",
    heroSubtitle: "Referência Completa ABNT",
    heroDescription: "Tabelas abrangentes de vãos para vigas de piso em construção residencial. Encontre os vãos máximos permitidos para cada seção, espaçamento, espécie e grau conforme ABNT NBR 7190.",
    quickAnswerHeading: "Resposta Rápida",
    quickAnswerText: "Uma viga de piso de Peroba Rosa 6x20 cm a 40 cm entre eixos pode vencer até 4,20 m para carga de uso de 200 kgf/m². Uma viga de 6x25 cm da mesma espécie a 40 cm vence até 5,30 m. Sempre verifique com a ABNT NBR 7190.",
    understandingHeading: "Entendendo os Vãos de Vigas de Piso",
    understandingText1: "O vão de uma viga de piso é a distância horizontal que a viga pode cobrir entre apoios sem flecha excessiva. A ABNT NBR 7190 estabelece os critérios baseados na seção, espécie, grau, espaçamento e cargas de projeto.",
    understandingText2: "Os vãos são calculados para carga de uso (pessoas, móveis — tipicamente 200 kgf/m²) e carga permanente (peso próprio — tipicamente 100 kgf/m²). A carga total determina a seção e espaçamento necessários.",
    understandingText3: "Os limites de flecha controlam os vãos. A ABNT NBR 7190 exige flecha máxima de L/200 para carga total e L/300 para carga de uso. Pisos rígidos previnem trincas em revestimentos cerâmicos.",
    spanTablesHeading: "Tabelas de Vãos por Espécie",
    spanTablesIntro: "Tabelas baseadas na ABNT NBR 7190 para pisos com carga de uso de 200 kgf/m² e permanente de 100 kgf/m². Vãos máximos em metros.",
    spanTablesColSize: "Seção da Viga",
    spanTablesCol12: "30 cm e/e",
    spanTablesCol16: "40 cm e/e",
    spanTablesCol24: "60 cm e/e",
    spanTablesBySpecies: [
      { species: "Peroba Rosa (Classe C40)", grade: "fb = 40 MPa, E = 12.500 MPa", rows: [
        { size: "6x16 cm", oc12: "3,80 m", oc16: "3,40 m", oc24: "2,80 m" },
        { size: "6x20 cm", oc12: "4,70 m", oc16: "4,20 m", oc24: "3,50 m" },
        { size: "6x25 cm", oc12: "5,90 m", oc16: "5,30 m", oc24: "4,40 m" },
        { size: "6x30 cm", oc12: "7,10 m", oc16: "6,30 m", oc24: "5,20 m" },
      ]},
      { species: "Eucalipto Grandis (Classe C30)", grade: "fb = 30 MPa, E = 12.000 MPa", rows: [
        { size: "6x16 cm", oc12: "3,50 m", oc16: "3,10 m", oc24: "2,60 m" },
        { size: "6x20 cm", oc12: "4,40 m", oc16: "3,90 m", oc24: "3,20 m" },
        { size: "6x25 cm", oc12: "5,50 m", oc16: "4,90 m", oc24: "4,00 m" },
        { size: "6x30 cm", oc12: "6,60 m", oc16: "5,80 m", oc24: "4,80 m" },
      ]},
      { species: "Pinus Tratado (Classe C25)", grade: "fb = 25 MPa, E = 8.500 MPa", rows: [
        { size: "6x16 cm", oc12: "3,00 m", oc16: "2,70 m", oc24: "2,20 m" },
        { size: "6x20 cm", oc12: "3,80 m", oc16: "3,40 m", oc24: "2,80 m" },
        { size: "6x25 cm", oc12: "4,70 m", oc16: "4,20 m", oc24: "3,50 m" },
        { size: "6x30 cm", oc12: "5,70 m", oc16: "5,00 m", oc24: "4,10 m" },
      ]},
      { species: "Ipê (Classe C60)", grade: "fb = 60 MPa, E = 18.500 MPa", rows: [
        { size: "6x16 cm", oc12: "4,30 m", oc16: "3,90 m", oc24: "3,20 m" },
        { size: "6x20 cm", oc12: "5,40 m", oc16: "4,80 m", oc24: "4,00 m" },
        { size: "6x25 cm", oc12: "6,70 m", oc16: "6,00 m", oc24: "5,00 m" },
        { size: "6x30 cm", oc12: "8,10 m", oc16: "7,20 m", oc24: "5,90 m" },
      ]},
    ],
    loadRequirementsHeading: "Requisitos de Carga para Pisos (ABNT)",
    loadRequirementsIntro: "A ABNT NBR 6120 especifica as cargas mínimas de projeto para pisos residenciais.",
    loadRequirementsItems: [
      "Ambientes gerais: 200 kgf/m² uso + 100 kgf/m² permanente = 300 kgf/m² total",
      "Dormitórios: 150 kgf/m² uso + 100 kgf/m² permanente = 250 kgf/m² total",
      "Varandas: 200 kgf/m² uso + 100 kgf/m² permanente",
      "Garagens: 300 kgf/m² uso (veículos de passeio)",
      "Pisos pesados (porcelanato sobre contrapiso): aumente permanente para 150–200 kgf/m²",
      "Carga concentrada: 100 kgf em área de 25x25 cm",
    ],
    loadRequirementsSummary: "Para a maioria dos pisos residenciais, use a tabela 200/100. Na dúvida, dimensione para a carga maior.",
    factorsHeading: "Fatores que Afetam o Vão",
    factorsIntro: "Diversos fatores reais podem aumentar ou diminuir a seção necessária.",
    factorsItems: [
      "Espécie e classe: Classes superiores (C40, C60) permitem vãos maiores.",
      "Espaçamento: 30 cm permite maiores vãos, 40 cm é padrão, 60 cm é econômico mas limita vãos.",
      "Apoio mínimo: 5 cm em madeira, 7,5 cm em alvenaria (ABNT NBR 7190).",
      "Entalhes: limitados ao terço externo do vão, máx. 1/4 da altura.",
      "Pisos pesados: porcelanato e pedra adicionam carga significativa.",
      "Balanços: limitados a 1/4 do vão posterior.",
    ],
    factorsSummary: "Use sempre a espécie e classe especificadas na madeira. Na dúvida, aumente uma seção.",
    codeReferencesHeading: "Referências Normativas ABNT",
    codeReferencesIntro: "Normas que regem vigas de piso residenciais.",
    codeReferencesItems: [
      "ABNT NBR 7190 — Projeto de estruturas de madeira",
      "ABNT NBR 6120 — Cargas para cálculo de estruturas",
      "ABNT NBR 7190 Seção 7 — Apoios mínimos",
      "ABNT NBR 7190 Seção 8 — Entalhes e furos",
      "ABNT NBR 15575 — Desempenho de edificações",
    ],
    codeReferencesSummary: "A ABNT NBR 7190 (2022) é a norma vigente. Verifique a edição em vigor.",
    calculatorCtaHeading: "Calcule Seus Materiais",
    calculatorCtaText: "Use nossas calculadoras para determinar quantas vigas, conectores e fixações você precisa.",
    calculatorLinks: [
      { label: "Calculadora de Vigas de Piso", href: "/calculators/floor-framing/floor-joist-calculator", description: "Quantidade de vigas, perimetrais e bloqueios." },
      { label: "Calculadora de Contrapiso", href: "/calculators/floor-framing/subfloor-calculator", description: "Chapas de compensado ou OSB." },
      { label: "Calculadora de Conectores", href: "/calculators/floor-framing/joist-hanger-calculator", description: "Conectores e parafusos estruturais." },
    ],
    faqHeading: "Perguntas Frequentes",
    faqs: [
      { question: "Qual o vão de uma viga 6x20 cm?", answer: "Para Peroba Rosa (C40) a 40 cm: 4,20 m. Para Pinus (C25): 3,40 m. Consulte a ABNT NBR 7190." },
      { question: "Qual o vão de uma viga 6x25 cm?", answer: "Peroba Rosa a 40 cm: 5,30 m. Eucalipto a 40 cm: 4,90 m. Ipê a 40 cm: 6,00 m." },
      { question: "Posso usar vigas 6x16 cm?", answer: "Sim, mas limitadas a 2,70–3,90 m dependendo da espécie. Adequadas para ambientes pequenos." },
      { question: "Diferença entre carga de uso e permanente?", answer: "Uso = pessoas e móveis (200 kgf/m²). Permanente = estrutura (100 kgf/m²). Juntas determinam a carga total." },
      { question: "Espaçamento 40 ou 60 cm?", answer: "40 cm é padrão. 60 cm economiza 33% de madeira mas limita vãos e requer contrapiso mais espesso." },
      { question: "Preciso de bloqueio?", answer: "Recomendado para vigas acima de 25 cm em intervalos de 2,40 m. Para menores, bloqueio no meio do vão reduz vibração." },
    ],
  },

  rafterSpanTable: {
    title: "Tabela de Vãos de Caibros: Referência Completa para Telhados",
    metaDescription: "Tabelas de vão de caibros para seções de 5x6 a 6x25 cm a 30, 40 e 60 cm. Cobre cargas de vento conforme ABNT NBR 7190 e NBR 6123.",
    heroTitle: "Tabela de Vãos de Caibros",
    heroSubtitle: "Referência Completa",
    heroDescription: "Tabelas abrangentes de vãos para caibros residenciais conforme ABNT NBR 7190.",
    quickAnswerHeading: "Resposta Rápida",
    quickAnswerText: "Um caibro de Peroba Rosa 6x16 cm a 40 cm vence até 3,80 m horizontalmente com carga padrão. Para regiões de ventos fortes o vão diminui.",
    understandingHeading: "Entendendo os Vãos de Caibros",
    understandingText1: "O vão de um caibro é a projeção horizontal entre a frechal e a cumeeira. O comprimento real é maior por seguir a inclinação.",
    understandingText2: "Cargas primárias: permanente (telhas, ripas — 50–80 kgf/m²) e uso (vento, manutenção — mín. 25 kgf/m²). Vento conforme ABNT NBR 6123.",
    understandingText3: "A ABNT NBR 7190 exige flecha máx. L/200. Inclinações maiores permitem vãos ligeiramente maiores.",
    spanTablesHeading: "Tabelas de Vãos por Espécie",
    spanTablesIntro: "Baseadas na ABNT NBR 7190 para carga de uso 25 kgf/m² + permanente 60 kgf/m² (telha cerâmica). Projeção horizontal em metros.",
    spanTablesColSize: "Seção",
    spanTablesCol12: "30 cm e/e",
    spanTablesCol16: "40 cm e/e",
    spanTablesCol24: "60 cm e/e",
    spanTablesBySpecies: [
      { species: "Peroba Rosa (C40)", grade: "fb = 40 MPa, E = 12.500 MPa", rows: [
        { size: "5x6 cm", oc12: "1,80 m", oc16: "1,60 m", oc24: "1,30 m" },
        { size: "6x12 cm", oc12: "3,20 m", oc16: "2,80 m", oc24: "2,30 m" },
        { size: "6x16 cm", oc12: "4,30 m", oc16: "3,80 m", oc24: "3,10 m" },
        { size: "6x20 cm", oc12: "5,40 m", oc16: "4,80 m", oc24: "3,90 m" },
        { size: "6x25 cm", oc12: "6,70 m", oc16: "6,00 m", oc24: "4,90 m" },
      ]},
      { species: "Eucalipto Grandis (C30)", grade: "fb = 30 MPa, E = 12.000 MPa", rows: [
        { size: "5x6 cm", oc12: "1,60 m", oc16: "1,40 m", oc24: "1,20 m" },
        { size: "6x12 cm", oc12: "2,90 m", oc16: "2,60 m", oc24: "2,10 m" },
        { size: "6x16 cm", oc12: "3,90 m", oc16: "3,50 m", oc24: "2,90 m" },
        { size: "6x20 cm", oc12: "4,90 m", oc16: "4,40 m", oc24: "3,60 m" },
        { size: "6x25 cm", oc12: "6,10 m", oc16: "5,50 m", oc24: "4,50 m" },
      ]},
      { species: "Pinus Tratado (C25)", grade: "fb = 25 MPa, E = 8.500 MPa", rows: [
        { size: "5x6 cm", oc12: "1,40 m", oc16: "1,20 m", oc24: "1,00 m" },
        { size: "6x12 cm", oc12: "2,50 m", oc16: "2,20 m", oc24: "1,80 m" },
        { size: "6x16 cm", oc12: "3,40 m", oc16: "3,00 m", oc24: "2,50 m" },
        { size: "6x20 cm", oc12: "4,20 m", oc16: "3,80 m", oc24: "3,10 m" },
        { size: "6x25 cm", oc12: "5,30 m", oc16: "4,70 m", oc24: "3,90 m" },
      ]},
    ],
    snowLoadHeading: "Impacto do Vento nos Vãos",
    snowLoadIntro: "A carga de vento reduz os vãos. A ABNT NBR 6123 define pressões por região.",
    snowLoadItems: [
      "Vento padrão (30 m/s): Caibro 6x16 vence até 3,80 m",
      "Vento moderado (35 m/s): vão reduz para ~3,40 m",
      "Vento forte (40 m/s): vão reduz para ~3,00 m",
      "Vento muito forte (45 m/s): vão cai para ~2,60 m",
      "Consulte o mapa de isopletas da ABNT NBR 6123",
      "Inclinações acima de 30% recebem menor sucção na face a sotavento",
    ],
    snowLoadSummary: "No Brasil, a carga de vento é o fator ambiental mais importante. Sempre dimensione para a velocidade da sua região.",
    pitchFactorsHeading: "Inclinação e Dimensionamento",
    pitchFactorsIntro: "A inclinação afeta comprimento real, distribuição de carga e necessidade de tirantes.",
    pitchFactorsItems: [
      "Baixa (10–20%): empuxo alto, tirantes obrigatórios",
      "Média (25–40%): componente perpendicular diminui, tirantes necessários",
      "Alta (45–100%): menos flexão, mas comprimento real muito maior",
      "Fatores de inclinação: 20%=1,020; 30%=1,044; 40%=1,077; 50%=1,118",
      "Cumeeira estrutural elimina necessidade de tirantes",
      "Tirantes na frechal vs jétkas no terço superior",
    ],
    pitchFactorsSummary: "Para 20–40% de inclinação, use tabelas diretamente. Para forro inclinado sem tirantes, cumeeira estrutural é obrigatória.",
    codeReferencesHeading: "Referências Normativas ABNT",
    codeReferencesIntro: "Normas que regem o dimensionamento de caibros.",
    codeReferencesItems: [
      "ABNT NBR 7190 — Estruturas de madeira",
      "ABNT NBR 6123 — Forças devidas ao vento",
      "ABNT NBR 6120 — Cargas para cálculo",
      "ABNT NBR 7190 Seção 7 — Apoios",
      "ABNT NBR 7190 Seção 8 — Entalhes",
      "ABNT NBR 15575 — Desempenho de coberturas",
    ],
    codeReferencesSummary: "Use ABNT NBR 7190 em conjunto com NBR 6123 (vento) e NBR 6120 (cargas).",
    calculatorCtaHeading: "Calcule Seus Materiais de Telhado",
    calculatorCtaText: "Use nossas calculadoras para determinar quantos caibros, quanto forro e quais fixações você precisa.",
    calculatorLinks: [
      { label: "Calculadora de Caibros", href: "/calculators/roofing/rafter-calculator", description: "Quantidade e comprimento da cumeeira." },
      { label: "Calculadora de Forro de Telhado", href: "/calculators/roofing/roof-sheathing-calculator", description: "Chapas de compensado ou OSB." },
      { label: "Calculadora de Telhas", href: "/calculators/roofing/shingle-calculator", description: "Quantidade de telhas e pregos." },
    ],
    faqHeading: "Perguntas Frequentes",
    faqs: [
      { question: "Vão máximo de caibro 6x12 cm?", answer: "Peroba Rosa a 40 cm: 2,80 m. Pinus a 40 cm: 2,20 m. Adequado para telhados pequenos e varandas." },
      { question: "Vão de caibro 5x6 cm?", answer: "Muito limitado: 1,20–1,60 m. Apenas para pergolados leves e coberturas curtas." },
      { question: "Cumeeira estrutural ou tábua?", answer: "Tábua de cumeeira quando há tirantes. Cumeeira estrutural (MLC) para forros inclinados sem tirantes." },
      { question: "Vento afeta os vãos?", answer: "Sim. 6x16 Peroba a 40 cm: 3,80 m com 30 m/s, ~2,60 m com 45 m/s — redução de 30%." },
      { question: "Terças intermediárias?", answer: "Sim. Terças apoiadas por escoras dividem o vão pela metade. Mínimo 6x8 cm, escora em parede nośna." },
      { question: "Seção mínima para casa?", answer: "Tipicamente 6x12 cm (até 2,80 m de vão). Para vãos maiores: 6x16 ou 6x20." },
    ],
  },

  ceilingJoistSpanTable: {
    title: "Tabela de Vãos de Vigas de Forro: Guia Completo",
    metaDescription: "Tabelas de vão de vigas de forro 5x6 a 6x20 cm a 30, 40 e 60 cm. Cobre forro leve, sótão com armazenamento e sótão habitável conforme ABNT.",
    heroTitle: "Tabela de Vãos de Vigas de Forro",
    heroSubtitle: "Guia Completo",
    heroDescription: "Tabelas de vãos para vigas de forro residenciais — de forros de gesso a pisos de sótão habitável.",
    quickAnswerHeading: "Resposta Rápida",
    quickAnswerText: "Uma viga de forro de Peroba Rosa 6x12 cm a 40 cm vence até 4,50 m para forro leve. Para sótão com armazenamento, o vão cai para 3,20 m.",
    understandingHeading: "Entendendo os Vãos",
    understandingText1: "Vigas de forro sustentam o acabamento abaixo e atuam como tirantes dos caibros. O vão depende do uso do sótão.",
    understandingText2: "Três condições: sótão sem acesso (50 kgf/m²), com armazenamento (50+100 kgf/m²) e habitável (50+150 kgf/m²).",
    understandingText3: "Quando atuam como tirantes, devem ser conectadas aos caibros com pregação adequada no terço inferior do vão.",
    spanTablesHeading: "Tabelas por Espécie",
    spanTablesIntro: "Baseadas na ABNT NBR 7190 com carga permanente de 50 kgf/m². Forro leve e armazenamento limitado.",
    spanTablesColSize: "Seção",
    spanTablesCol12: "30 cm e/e",
    spanTablesCol16: "40 cm e/e",
    spanTablesCol24: "60 cm e/e",
    spanTablesBySpecies: [
      { species: "Peroba Rosa — Forro Leve", grade: "C40 — 50 kgf/m² permanente", rows: [
        { size: "5x6 cm", oc12: "2,80 m", oc16: "2,50 m", oc24: "2,10 m" },
        { size: "6x12 cm", oc12: "5,10 m", oc16: "4,50 m", oc24: "3,70 m" },
        { size: "6x16 cm", oc12: "6,80 m", oc16: "6,00 m", oc24: "4,90 m" },
        { size: "6x20 cm", oc12: "8,50 m", oc16: "7,50 m", oc24: "6,20 m" },
      ]},
      { species: "Peroba Rosa — Armazenamento Limitado", grade: "C40 — 50+100 kgf/m²", rows: [
        { size: "5x6 cm", oc12: "1,90 m", oc16: "1,70 m", oc24: "1,40 m" },
        { size: "6x12 cm", oc12: "3,60 m", oc16: "3,20 m", oc24: "2,60 m" },
        { size: "6x16 cm", oc12: "4,80 m", oc16: "4,20 m", oc24: "3,50 m" },
        { size: "6x20 cm", oc12: "6,00 m", oc16: "5,30 m", oc24: "4,40 m" },
      ]},
      { species: "Pinus Tratado — Forro Leve", grade: "C25 — 50 kgf/m²", rows: [
        { size: "5x6 cm", oc12: "2,30 m", oc16: "2,00 m", oc24: "1,70 m" },
        { size: "6x12 cm", oc12: "4,20 m", oc16: "3,70 m", oc24: "3,00 m" },
        { size: "6x16 cm", oc12: "5,60 m", oc16: "4,90 m", oc24: "4,00 m" },
        { size: "6x20 cm", oc12: "7,00 m", oc16: "6,20 m", oc24: "5,10 m" },
      ]},
      { species: "Eucalipto — Armazenamento Limitado", grade: "C30 — 50+100 kgf/m²", rows: [
        { size: "5x6 cm", oc12: "1,80 m", oc16: "1,60 m", oc24: "1,30 m" },
        { size: "6x12 cm", oc12: "3,30 m", oc16: "2,90 m", oc24: "2,40 m" },
        { size: "6x16 cm", oc12: "4,40 m", oc16: "3,90 m", oc24: "3,20 m" },
        { size: "6x20 cm", oc12: "5,50 m", oc16: "4,90 m", oc24: "4,00 m" },
      ]},
    ],
    loadTypesHeading: "Tipos de Carga Explicados",
    loadTypesIntro: "Três categorias de carga conforme ABNT.",
    loadTypesItems: [
      "Sótão sem acesso (50 kgf/m²): sem alçapão, apenas manutenção eventual. Maiores vãos.",
      "Armazenamento limitado (100 kgf/m²): alçapão ou escada retrátil, uso leve. Tabela mais usada.",
      "Habitável (150 kgf/m²): pé-direito mín. 2,20 m. Use tabelas de piso se for sala ou dormitório.",
      "Se planeja converter futuramente, dimensione desde já para carga habitável.",
      "HVAC no sótão: adicione 50–100 kgf/m² ou construa plataforma dedicada.",
    ],
    loadTypesSummary: "Na dúvida, dimensione para armazenamento (100 kgf/m²). Custo pouco maior, flexibilidade futura.",
    factorsHeading: "Fatores que Afetam os Vãos",
    factorsIntro: "Fatores além de carga e espécie.",
    factorsItems: [
      "Tirante: vigas como tirantes sofrem tração. Conectar aos caibros com pregação adequada.",
      "Peso do forro: gesso 12,5 mm pesa ~10 kgf/m². Para forro de madeira, ajuste.",
      "Isolamento: lã de vidro R-4.0 adiciona 5–15 kgf/m².",
      "Espaçamento e forro: 60 cm requer gesso 15 mm.",
      "Contraventamento: sarrafos contínuos sobre as vigas no meio do vão.",
    ],
    factorsSummary: "Vigas de forro cumprem funções estruturais críticas como tirantes. Dimensione e conecte corretamente.",
    codeReferencesHeading: "Referências Normativas",
    codeReferencesIntro: "Normas aplicáveis a vigas de forro.",
    codeReferencesItems: [
      "ABNT NBR 7190 — Dimensionamento de vigas de forro",
      "ABNT NBR 7190 — Ligações viga-caibro quando atuam como tirantes",
      "ABNT NBR 15575 — Flecha e acústica para forros",
      "ABNT NBR 14715 — Espaçamento de apoio para forro de gesso",
    ],
    codeReferencesSummary: "O dimensionamento cruza com caibros (NBR 7190), forro (NBR 14715) e ventilação do sótão.",
    calculatorCtaHeading: "Calcule Seus Materiais de Forro",
    calculatorCtaText: "Use nossas calculadoras para vigas, gesso e fixações.",
    calculatorLinks: [
      { label: "Calculadora de Vigas", href: "/calculators/floor-framing/floor-joist-calculator", description: "Também para vigas de forro." },
      { label: "Calculadora de Drywall", href: "/calculators/insulation-drywall/drywall-calculator", description: "Chapas, massa e parafusos." },
      { label: "Calculadora de Isolamento", href: "/calculators/insulation-drywall/insulation-calculator", description: "Mantas ou soprado para o sótão." },
    ],
    faqHeading: "Perguntas Frequentes",
    faqs: [
      { question: "Vão de viga de forro 6x12 cm?", answer: "Peroba Rosa a 40 cm: 4,50 m forro leve, 3,20 m armazenamento. Consulte tabela da sua espécie." },
      { question: "Vigas 5x6 cm para forro?", answer: "Sim, até 2,50 m a 40 cm para forro leve. ~1,70 m com armazenamento. Para ambientes pequenos." },
      { question: "Direção das vigas vs caibros?", answer: "Como tirantes, devem ser paralelas aos caibros. Se perpendiculares, necessita tirantes separados ou cumeeira estrutural." },
      { question: "Diferença viga de forro vs piso?", answer: "Mesma estrutura, carga diferente. Forro: 50–150 kgf/m². Piso: 200–300 kgf/m². Forro vence vãos maiores na mesma seção." },
      { question: "Posso pisar nas vigas de forro?", answer: "Sim para armazenamento (100 kgf/m²) ou habitável. Não para forro leve — pode trincar gesso ou falhar." },
      { question: "Como reforçar vigas existentes?", answer: "Emparelhar: aparafusar nova viga ao lado. Parafusos sextavados 10 mm a cada 40 cm. Deve apoiar nos mesmos suportes." },
    ],
  },
};
